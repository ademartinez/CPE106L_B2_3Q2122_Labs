"""
Author: Fiona S. Nabua
Filename: bank.py
Program Description: The program outputs the string of the name of accounts in order. 
"""
...
def createBank(numAccounts=1):
    ...
    accounts."""
    names = ("Fiona", "Ade", "Hannah", "Ivan", "Red",
             "Kenji", "Jilroy", "Matt")
    bank = Bank()
...
def testAccount():
    ...
    account = SavingsAccount("Kenji", "1000", 500.00)
    print(account)
